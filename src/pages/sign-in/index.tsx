...
const Index = () => {
  ...
  return (
    <>
      <SEO
        title="Sign In - Candivet"
        description="Sign in to your Candivet account to access your dashboard and start using our platform."
        canonical="https://candivet.com/sign-in"
        ogType="website"
      />
