...
const index = () => {
  ...
  return (
    <>
      <SEO
        title="About Us - Candivet"
        description="At Candivet, we're transforming the way professionals connect with opportunities by merging technology with human-centered design to support every stage of the hiring journey."
        canonical="https://candivet.com/about"
        ogType="website"
      />
      <LandingWrapper>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  design to support every stage of the hiring journey. Built
                  with AI-driven tools, Candivet provides a comprehensive
                  platform for recruiters and job seekers to simplify the job
                  search, application, and candidate vetting processes.
                </motion.p>
