...
const Generator = () => {
  ...
  const downloadPDF = async (template: string) => {
    ...
    try {
      ...
      pdf.setFontSize(16);
      const title = generatedCoverLetter?.[0].candidate_name
        ? `${generatedCoverLetter[0].candidate_name} - Cover Letter`
        : "Cover Letter";
      pdf.text(title, 216 / 2, 15, { align: "center" });

      // Add company name if available
      if (generatedCoverLetter?.[0].company) {
        pdf.setFontSize(12);
        pdf.text(generatedCoverLetter[0].company, 216 / 2, 22, {
          align: "center",
        });
      }
              ...
              <Plus
                ...
                onClick={() => {
                  if (value && prompts.length < 20) {
                    setPrompts((prev: any) => [...prev, value]);
                    setValue("");
                  }
                }}
              />
              ...
              {isSuccess && (
                <div className="h-full space-y-8">
                  <div className="relative">
                    ...
                    <div
                      ref={template1Ref}
                      className=" bg-white w-full rounded-lg shadow-sm min-h-[500px] overflow-hidden template-container"
                    >
                      <CoverLetterTemplate1 data={generatedCoverLetter?.[0]} />
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div
                      ...
                      className=" bg-white w-full rounded-lg shadow-sm min-h-[500px] overflow-hidden template-container"
                    >
                      <CoverLetterTemplate data={generatedCoverLetter?.[0]} />
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div
                      ...
                      className=" bg-white w-full rounded-lg shadow-sm min-h-[500px] overflow-hidden template-container"
                    >
                      <CoverLetterTemplate2 data={generatedCoverLetter?.[0]} />
                    </div>
                  </div>
