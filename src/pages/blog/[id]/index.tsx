...
const BlogPostDetail = () => {
  ...
  return (
    <>
      <SEO
        title={`${blog.title} - Candivet Blog`}
        description={
          blog.content
            ? blog.content.replace(/<[^>]*>/g, "").substring(0, 160) + "..."
            : "Read this article on Candivet blog"
        }
        canonical={`https://candivet.com/blog/${id}`}
        ogType="article"
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="w-full max-w-[1920px] mx-auto px-4 md:px-16 py-12">
          <div className="relative flex gap-8">
            {/* Side Social Panel - Pinned to left */}
            <div className="text-[12px] hidden lg:flex flex-col items-center gap-8 pt-[20px] h-fit flex-shrink-0">
            ...
            <div className="flex-1 flex justify-center">
              <div
                className={`${inter.className} pt-[14px] space-y-6 text-gray-800 max-w-3xl w-full`}
              >
                {blog.image && (
          ...
          <div className="relative flex gap-8 mt-12 mb-8">
            {/* Empty sidebar to match the one above */}
            <div className="text-[12px] hidden lg:flex flex-col items-center gap-8 pt-[20px] h-fit flex-shrink-0 min-w-[39px] w-[39px]">
              {/* Empty space to match sidebar width */}
            </div>

            {/* Social share content */}
            <div className="flex-1 flex justify-center">
              <div className="grid grid-cols-4 gap-0 max-w-3xl w-full">
          ...
          {/* Comments Section */}
          <div className="relative flex gap-8 mt-12 mb-16">
            {/* Empty sidebar to match the one above */}
            <div className="text-[12px] hidden lg:flex flex-col items-center gap-8 pt-[20px] h-fit flex-shrink-0 min-w-[39px] w-[39px]">
              {/* Empty space to match sidebar width */}
            </div>
