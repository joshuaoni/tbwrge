...
const TermsOfService = () => (
  <>
    <SEO
      title="Terms of Service - Candivet"
      description="Read Candivet's terms of service to understand your rights and responsibilities when using our AI-powered hiring platform."
      canonical="https://candivet.com/terms-of-service"
      ogType="website"
    />
    <LandingWrapper>
      <div
      ...
      >
        <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <p className="mb-2 text-gray-700">
            ...
            MIXT Technologies operates. Contact us at{" "}
            <a
