...
const ForgotPassword = () => {
  ...
  return (
    <>
      <SEO
        title="Forgot Password - Candivet"
        description="Reset your Candivet account password. Enter your email to receive password reset instructions."
        canonical="https://candivet.com/forgot-password"
        ogType="website"
      />
