...
const ToolsPage = () => {
  ...
  return (
    <>
      <SEO
        title="Tools - Candivet"
        description="Discover Candivet's comprehensive suite of AI-powered tools for job posting, CV management, and cover letter creation. Streamline your hiring process with our advanced recruitment tools."
        canonical="https://candivet.com/tools"
        ogType="website"
      />
      <LandingWrapper>
                    ...
                    <div className="w-[45%]">
                      <div className="flex flex-col space-y-2  min-h-[400px] max-w-[450px] rounded-lg justify-center px-4 md:px-0">
                        ...
                        <p className="leading-[1.6] pt-4 text-[#252525CC] text-sm">
                          Candivet's Job Tools simplify the recruiting process
                          by enabling recruiters to create, refine, and manage
                          job postings effortlessly. The Job Post Generator
                          creates polished, detailed job descriptions from
                          essential role details, helping recruiters publish
                          effective listings. With the Job Post Translator,
                          recruiters can instantly translate posts, reaching a
                          wider audience without losing accuracy. Job Post
                          Vetting reviews and improves job posts to ensure they
                          meet industry standards, enhancing their appeal to
                          potential applicants. Lastly, the Candidate Report
                          Generator compiles detailed candidate insights into
                          structured reports, helping recruiters make informed
                  ...
                  <div className="px-4 md:px-16 space-x-32 flex items-center">
                    ...
                    <div className="w-[45%]">
                      <div className="flex flex-col space-y-2 min-h-[400px] max-w-[450px] rounded-lg justify-center px-4 md:px-0">
                        ...
                        <p className="leading-[1.6] pt-4 text-[#252525CC] text-sm">
                          The CV Tools suite is designed to help both job
                          seekers and recruiters create and evaluate CVs that
                          match job requirements precisely. CV Generator tailors
                          CVs specifically for each job ad, focusing on relevant
                          skills and experiences to increase candidate appeal.
                          For recruiters, CV Summarizer distills lengthy CVs
                          into concise overviews, making it easier to assess
                          core qualifications. CV Matching & Vetting provides a
                    ...
                    <div className="w-[45%]">
                      <div className="flex flex-col space-y-2 min-h-[400px] max-w-[450px] rounded-lg justify-center px-4 md:px-0">
                        ...
                        <p className="leading-[1.6] pt-4 text-[#252525CC] text-sm">
                          ...
                          and for recruiters to assess them efficiently. The
                          Cover Letter Generator produces customized cover
                          letters based on job descriptions, emphasizing
                          relevant skills to strengthen applications. Cover
                          Letter Summarizer condenses cover letters, focusing on
                          key points so recruiters can quickly gauge candidate
                          suitability. Cover Letter Matching & Vetting aligns
                          cover letters with job criteria, offering
                          compatibility insights, while Cover Letter Ranking
                          prioritizes cover letters by relevance to the job,
                          helping recruiters review applicants efficiently. The
                          Cover Letter Translator allows candidates to broaden
                          their reach by converting cover letters into various
                          languages, enabling access to global opportunities.
                        </p>
                      </div>
                    </div>
                    <div className="w-[45%] flex justify-start relative">
