    ...
    <DashboardWrapper>
      <div className="mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-lg h-[300px] shadow-md">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <p>
              <strong>Key Skills:</strong> {candidate.insights.skills}
            </p>
            <p>
              <strong>Strengths:</strong> {candidate.insights.strengths}
            </p>
            <p>
              <strong>Culture Fit Indicators:</strong>{" "}
