...
const PricingPage = () => {
  ...
  return (
    <>
      <SEO
        title="Pricing - Candivet"
        description="Choose the Perfect Pricing for Your Hiring and Career Goals. From free trials to enterprise solutions, find the right plan for your needs."
        canonical="https://candivet.com/pricing"
        ogType="website"
      />
      <LandingWrapper>
        <motion.main
              ...
              <div className="overflow-hidden">
                ...
                >
                  {pricingPlans.map((plan, index) => (
                    <div
                      key={index}
                      className="w-full h-fit flex-shrink-0 px-4"
                    >
                      <div
                        className={`${outfit.className} flex flex-col ${
                  ...
                  >
                    ...
                    <div className="!h-fit mt-[40px]">
                      <div className="[&>*]:h-[40px] [&>*]:flex [&>*]:items-center [&>*]:justify-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[0].jobTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                    ...
                    <div className="!h-fit mt-[40px]">
                      <div className="[&>*]:h-[40px] [&>*]:flex [&>*]:items-center [&>*]:justify-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[0].cvTools.summarizer
                          )}
                        </div>
                        <div>
                        ...
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[0].cvTools.headToHead
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[0].cvTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[0].cvTools.translator
                          )}
                        </div>
                        <div>
                  ...
                  >
                    ...
                    <div className="!h-fit mt-[40px]">
                      <div className="[&>*]:h-[40px] [&>*]:flex [&>*]:items-center [&>*]:justify-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[1].jobTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                    ...
                    <div className="!h-fit mt-[40px]">
                      <div className="[&>*]:h-[40px] [&>*]:flex [&>*]:items-center [&>*]:justify-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[1].cvTools.summarizer
                          )}
                        </div>
                        <div>
                        ...
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[1].cvTools.headToHead
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[1].cvTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[1].cvTools.translator
                          )}
                        </div>
                        <div>
                  ...
                  >
                    ...
                    <div className="!h-fit mt-[40px] text-center">
                      <div className="[&>*]:p-4 [&>*]:h-[40px] [&>*]:flex [&>*]:justify-center [&>*]:items-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[2].jobTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                    ...
                    <div className="!h-fit mt-[40px] text-center">
                      <div className="[&>*]:p-4 [&>*]:h-[40px] [&>*]:flex [&>*]:justify-center [&>*]:items-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[2].cvTools.summarizer
                          )}
                        </div>
                        <div>
                        ...
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[2].cvTools.headToHead
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[2].cvTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[2].cvTools.translator
                          )}
                        </div>
                        <div>
                  ...
                  >
                    ...
                    <div className="!h-fit  mt-[40px] text-center">
                      <div className="[&>*]:p-4 [&>*]:h-[40px] [&>*]:flex [&>*]:justify-center [&>*]:items-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[3].jobTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                    ...
                    <div className="!h-fit mt-[40px] text-center">
                      <div className="[&>*]:p-4 [&>*]:h-[40px] [&>*]:flex [&>*]:justify-center [&>*]:items-center">
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[3].cvTools.summarizer
                          )}
                        </div>
                        <div>
                        ...
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[3].cvTools.headToHead
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[3].cvTools.generator
                          )}
                        </div>
                        <div>
                          {renderCheckOrValue(
                            pricingPlans[3].cvTools.translator
                          )}
                        </div>
                        <div>
