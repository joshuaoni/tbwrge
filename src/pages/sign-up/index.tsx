...
const SignUpPage = () => {
  ...
  return (
    <>
      <SEO
        title="Sign Up - Candivet"
        description="Create your Candivet account to start using AI-powered hiring tools, job postings, and recruitment features."
        canonical="https://candivet.com/sign-up"
        ogType="website"
      />
